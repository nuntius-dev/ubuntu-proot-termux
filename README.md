...
```
 2. Copia, pega y ejecuta este comando para iniciar la instalación mágica:
   ```bash
   curl -sL [https://raw.githubusercontent.com/nuntius-dev/ubuntu-proot-termux/main/install-ubuntu-termux.sh](https://raw.githubusercontent.com/nuntius-dev/ubuntu-proot-termux/main/install-ubuntu-termux.sh) | bash
